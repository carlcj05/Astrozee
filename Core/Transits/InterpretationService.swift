...
final class InterpretationService {
    ...
    func loadInterpretations() {
        ...
        guard let url = Bundle.main.url(forResource: "interpretations.clean", withExtension: "json") else {
            print("❌ Fichier interpretations.clean.json introuvable dans le bundle")
            return
        }
